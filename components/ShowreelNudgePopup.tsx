...
// A single popup carrying both nudges — the full archive and the
// About page's 3D scene — rather than two separate small hints
// competing for attention. Fires once per 1-hour window (see
// useOneTimeHint), a flat 5s after the landing panel mounts, and stays
// up until dismissed or a CTA is used.
